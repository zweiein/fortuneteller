...
namespace NinjaTrader.Data
{
    public class UniRenkoBarsType : BarsType
    {
        ...
        public override PropertyDescriptorCollection GetProperties(PropertyDescriptor propertyDescriptor, Period period, Attribute[] attributes)
        {
            ...
            Gui.Design.DisplayNameAttribute.SetDisplayName(properties, "Value2", "\r\rTick \r\rReversal");
            Gui.Design.DisplayNameAttribute.SetDisplayName(properties, "Value",  "\r\rTick \r\r\rTrend");
            Gui.Design.DisplayNameAttribute.SetDisplayName(properties, "BasePeriodValue",  "\r\rTick \rOpen Offset");
