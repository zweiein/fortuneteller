...
namespace NinjaTrader.Indicator
{
	...
	public class MurreyMathSimple : Indicator
	{
		#region Variables
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private MurreyMathSimple[] cacheMurreyMathSimple = null;

        private static MurreyMathSimple checkMurreyMathSimple = new MurreyMathSimple();

        /// <summary>
        /// Murrey Math Indicator (version 1.5.1) NT7 compatible
        /// </summary>
        /// <returns></returns>
        public MurreyMathSimple MurreyMathSimple()
        {
            return MurreyMathSimple(Input);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MurreyMathSimple MurreyMathSimple(Data.IDataSeries input)
        {
            if (cacheMurreyMathSimple != null)
                for (int idx = 0; idx < cacheMurreyMathSimple.Length; idx++)
                    if (cacheMurreyMathSimple[idx].EqualsInput(input))
                        return cacheMurreyMathSimple[idx];

            lock (checkMurreyMathSimple)
            {
                if (cacheMurreyMathSimple != null)
                    for (int idx = 0; idx < cacheMurreyMathSimple.Length; idx++)
                        if (cacheMurreyMathSimple[idx].EqualsInput(input))
                ...
                MurreyMathSimple indicator = new MurreyMathSimple();
                ...
                MurreyMathSimple[] tmp = new MurreyMathSimple[cacheMurreyMathSimple == null ? 1 : cacheMurreyMathSimple.Length + 1];
                if (cacheMurreyMathSimple != null)
                    cacheMurreyMathSimple.CopyTo(tmp, 0);
                tmp[tmp.Length - 1] = indicator;
                cacheMurreyMathSimple = tmp;
                return indicator;
            }
        }
    }
...
namespace NinjaTrader.MarketAnalyzer
{
    public partial class Column : ColumnBase
    {
        ...
        public Indicator.MurreyMathSimple MurreyMathSimple()
        {
            return _indicator.MurreyMathSimple(Input);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Indicator.MurreyMathSimple MurreyMathSimple(Data.IDataSeries input)
        {
            return _indicator.MurreyMathSimple(input);
        }
    }
