...
namespace NinjaTrader.Strategy
{
   ...
   public class PrintSQNDashboard : Strategy
   {
      #region Variables
      private string excelFilename = @"Market Dashboard ";
...
System.Threading.Thread.CurrentThread.CurrentCulture = new System.Globalization.CultureInfo("en-US");
      ...
      private void PrintStockMarketSummary()
      {
         ...
         stockMarketWorksheet.Cells[foreignCurrencyRow + 1, foreignCurrencyColumn + 2] = @"SQN(200)";
         stockMarketWorksheet.Cells[foreignCurrencyRow + 1, foreignCurrencyColumn + 3] = @"SQN(100)";
         stockMarketWorksheet.Cells[foreignCurrencyRow + 1, foreignCurrencyColumn + 4] = @"SQN(50)";
         stockMarketWorksheet.Cells[foreignCurrencyRow + 1, foreignCurrencyColumn + 5] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[commoditiesRow + 1, commoditiesColumn + 2] = @"SQN(200)";
         stockMarketWorksheet.Cells[commoditiesRow + 1, commoditiesColumn + 3] = @"SQN(100)";
         stockMarketWorksheet.Cells[commoditiesRow + 1, commoditiesColumn + 4] = @"SQN(50)";
         stockMarketWorksheet.Cells[commoditiesRow + 1, commoditiesColumn + 5] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[realEstateRow + 1, realEstateColumn + 2] = @"SQN(200)";
         stockMarketWorksheet.Cells[realEstateRow + 1, realEstateColumn + 3] = @"SQN(100)";
         stockMarketWorksheet.Cells[realEstateRow + 1, realEstateColumn + 4] = @"SQN(50)";
         stockMarketWorksheet.Cells[realEstateRow + 1, realEstateColumn + 5] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[interestRateRow + 1, interestRateColumn + 2] = @"SQN(200)";
         stockMarketWorksheet.Cells[interestRateRow + 1, interestRateColumn + 3] = @"SQN(100)";
         stockMarketWorksheet.Cells[interestRateRow + 1, interestRateColumn + 4] = @"SQN(50)";
         stockMarketWorksheet.Cells[interestRateRow + 1, interestRateColumn + 5] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[3, 13] = @"SQN(200)";
         stockMarketWorksheet.Cells[3, 14] = @"SQN(100)";
         stockMarketWorksheet.Cells[3, 15] = @"SQN(50)";
         stockMarketWorksheet.Cells[3, 16] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[23, 13] = @"SQN(200)";
         stockMarketWorksheet.Cells[23, 14] = @"SQN(100)";
         stockMarketWorksheet.Cells[23, 15] = @"SQN(50)";
         stockMarketWorksheet.Cells[23, 16] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[57, 13] = @"SQN(200)";
         stockMarketWorksheet.Cells[57, 14] = @"SQN(100)";
         stockMarketWorksheet.Cells[57, 15] = @"SQN(50)";
         stockMarketWorksheet.Cells[57, 16] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[asiaRow + 1, asiaColumn + 2] = @"SQN(200)";
         stockMarketWorksheet.Cells[asiaRow + 1, asiaColumn + 3] = @"SQN(100)";
         stockMarketWorksheet.Cells[asiaRow + 1, asiaColumn + 4] = @"SQN(50)";
         stockMarketWorksheet.Cells[asiaRow + 1, asiaColumn + 5] = @"SQN(25)";
         ...
         stockMarketWorksheet.Cells[19, 22] = @"SQN(200)";
         stockMarketWorksheet.Cells[19, 23] = @"SQN(100)";
         stockMarketWorksheet.Cells[19, 24] = @"SQN(50)";
         stockMarketWorksheet.Cells[19, 25] = @"SQN(25)";
		 Print( "SO FAR");
      ...
      private void PrintSQNValues(Excel.Worksheet worksheet, int startingBarsArrayIndex, int numToPrint, int startingExcelRow, int startingExcelColumn)
      {
         ...
         for (int i = startingBarsArrayIndex; i < startingBarsArrayIndex + numToPrint; i++)
         {
            ...
            sqn = Math.Round(SQN(BarsArray[i], 200)[0], 2);
            ...
            sqn = Math.Round(SQN(BarsArray[i], 100)[0], 2);
            ...
            sqn = Math.Round(SQN(BarsArray[i], 50)[0], 2);
            ...
            sqn = Math.Round(SQN(BarsArray[i], 25)[0], 2);
      ...
      {
         string sqnStringValue = SQN(1).GetSQNStringValue(sqnValue);
