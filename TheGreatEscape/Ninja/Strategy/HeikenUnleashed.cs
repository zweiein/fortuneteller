...
namespace NinjaTrader.Strategy
{
    ...
    public class HeikenUnleashed : Strategy
    {
        #region Variables
        ...
        private int startTradeTime = 73000;
        ...
        protected override void Initialize()
        {
            ...
            */
			...
			Add(HeikenAshiSmoothed(0.7, HAMA.SMA, HAMA.SMMA, 1, 2));//.HAClose[0];
        }
        ...
        protected override void OnBarUpdate()
        {
            ...
            {
				double haL=HeikenAshiSmoothed(0.7, HAMA.SMA, HAMA.SMMA, 1, 2).HALow[0];
				double haC=HeikenAshiSmoothed(0.7, HAMA.SMA, HAMA.SMMA, 1, 2).HAClose[0];
				double haH=HeikenAshiSmoothed(0.7, HAMA.SMA, HAMA.SMMA, 1, 2).HAHigh[0];
				double haO=HeikenAshiSmoothed(0.7, HAMA.SMA, HAMA.SMMA, 1, 2).HAOpen[0];
				...
				if (haC>haO && Close[0]>Open[0] && Open[0]>haC){
						GoLong();
				}
				if (haC<haO && Close[0]<Open[0] && Open[0]<haC){
						GoShort();	
