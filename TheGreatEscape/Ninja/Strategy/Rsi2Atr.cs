...
namespace NinjaTrader.Strategy
{
    ...
    public class Rsi2Atr : Strategy
    {
		...
		private double atrDiffFactor= 2;
		...
		private void EnterLongPos(){
			if (ATR(AtrPeriods)[0]<(ATR(AtrPeriods)[1]*AtrDiffFactor))return;
			if (useLimitOrders){
        ...
        [Description("")]
        [GridCategory("Parameters")]
        public double AtrDiffFactor
        {
            get { return atrDiffFactor; }
            set { atrDiffFactor = value; }
        }
        [Description("")]
        [GridCategory("Parameters")]
