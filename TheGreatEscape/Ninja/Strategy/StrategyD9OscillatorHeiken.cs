...
{ 
    ...
    public class StrategyD9OscillatorHeiken : MultiOrderStrategy
    {
        #region Variables
        ...
        protected override void InitializeIndicators()
        {
            ...
            Add(d9ParticleOscillator_V2(anaHeikinAshi(anaHeikinAshiType.Dan_Valcu, 10, anaHAMAType.Median).HAOpen, D9Period, D9Phase));
        ...
        protected override void OnBarUpdateImpl(){				
            // Condition set 1
            if (CrossAbove(d9ParticleOscillator_V2(anaHeikinAshi(anaHeikinAshiType.Dan_Valcu, 10, anaHAMAType.Median).HAOpen, D9Period, D9Phase).Prediction, 0, 1))
            {
                GoLong();
            }

            // Condition set 2
            if (CrossBelow(d9ParticleOscillator_V2(anaHeikinAshi(anaHeikinAshiType.Dan_Valcu, 10, anaHAMAType.Median).HAOpen, D9Period, D9Phase).Prediction, 0, 1))
            {
                GoShort();
            }
