...
namespace NinjaTrader.Strategy
{
    ...
    public class Meander1 : Strategy
    {
        #region Variables
		...
		*/	
        ...
        protected override void OnBarUpdate()
        {
			...
			if (MarketPosition.Flat==Position.MarketPosition ){							
				...
				if (MarketPosition.Long==Position.MarketPosition && Position.AvgPrice<price && BarsSinceEntry()>1)
					ManageOrders(1,-1); 
				else if (MarketPosition.Short==Position.MarketPosition && Position.AvgPrice>price  && BarsSinceEntry()>1)
					ManageOrders(1,1); 				
		...
		private void EnterShortLim(int position){
			...
			this.EnterShortLimit(lots,price, "Short");
		...
		private void EnterLongLim(int position){
			...
			this.EnterLongLimit(lots,price,"Long");
